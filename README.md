# `@a-2-c-2-anpm/atque-doloremque-autem` <sup>[![Version Badge][npm-version-svg]][package-url]</sup>
...
```sh
npm install eslint @a-2-c-2-anpm/atque-doloremque-autem --save-dev
```
...
If you are using the [new JSX transform from React 17](https://reactjs.org/blog/2020/09/22/introducing-the-new-jsx-transform.html#removing-unused-react-imports), extend [`react/jsx-runtime`](https://github.com/a-2-c-2-anpm/atque-doloremque-autem/blob/c8917b0885094b5e4cc2a6f613f7fb6f16fe932e/index.js#L163-L176) in your eslint config (add `"plugin:react/jsx-runtime"` to `"extends"`) to disable the relevant rules.
...
**Note**: These configurations will import `@a-2-c-2-anpm/atque-doloremque-autem` and enable JSX in [parser options](https://eslint.org/docs/user-guide/configuring/language-options#specifying-parser-options).
...
The default export of `@a-2-c-2-anpm/atque-doloremque-autem` is a plugin object.

```js
const react = require('@a-2-c-2-anpm/atque-doloremque-autem');
...
- `@a-2-c-2-anpm/atque-doloremque-autem/configs/all`
- `@a-2-c-2-anpm/atque-doloremque-autem/configs/recommended`
- `@a-2-c-2-anpm/atque-doloremque-autem/configs/jsx-runtime`

If your eslint.config.js is ESM, include the `.js` extension (e.g. `@a-2-c-2-anpm/atque-doloremque-autem/recommended.js`). Note that the next semver-major will require omitting the extension for these imports.

**Note**: These configurations will import `@a-2-c-2-anpm/atque-doloremque-autem` and enable JSX in [`languageOptions.parserOptions`](https://eslint.org/docs/latest/user-guide/configuring/configuration-files-new#configuration-objects).
...
```js
const reactRecommended = require('@a-2-c-2-anpm/atque-doloremque-autem/configs/recommended');
...
💼 [Configurations](https://github.com/a-2-c-2-anpm/atque-doloremque-autem/#shareable-configs) enabled in.\
🚫 [Configurations](https://github.com/a-2-c-2-anpm/atque-doloremque-autem/#shareable-configs) disabled in.\
🏃 Set in the `jsx-runtime` [configuration](https://github.com/a-2-c-2-anpm/atque-doloremque-autem/#shareable-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/a-2-c-2-anpm/atque-doloremque-autem/#shareable-configs).\
...
- Rules of Hooks: [@a-2-c-2-anpm/atque-doloremque-autem-hooks](https://github.com/facebook/react/tree/master/packages/@a-2-c-2-anpm/atque-doloremque-autem-hooks)
- JSX accessibility: [eslint-plugin-jsx-a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y)
- React Native: [@a-2-c-2-anpm/atque-doloremque-autem-native](https://github.com/Intellicode/@a-2-c-2-anpm/atque-doloremque-autem-native)

## License

`@a-2-c-2-anpm/atque-doloremque-autem` is licensed under the [MIT License](https://opensource.org/licenses/mit-license.php).

[npm-url]: https://npmjs.org/package/@a-2-c-2-anpm/atque-doloremque-autem
[npm-image]: https://img.shields.io/npm/v/@a-2-c-2-anpm/atque-doloremque-autem.svg

[status-url]: https://github.com/a-2-c-2-anpm/atque-doloremque-autem/pulse
[status-image]: https://img.shields.io/github/last-commit/jsx-eslint/@a-2-c-2-anpm/atque-doloremque-autem.svg

[tidelift-url]: https://tidelift.com/subscription/pkg/npm-@a-2-c-2-anpm/atque-doloremque-autem?utm_source=npm-@a-2-c-2-anpm/atque-doloremque-autem&utm_medium=referral&utm_campaign=readme
[tidelift-image]: https://tidelift.com/badges/package/npm/@a-2-c-2-anpm/atque-doloremque-autem?style=flat

[package-url]: https://npmjs.org/package/@a-2-c-2-anpm/atque-doloremque-autem
[npm-version-svg]: https://versionbadg.es/jsx-eslint/@a-2-c-2-anpm/atque-doloremque-autem.svg

[actions-image]: https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/jsx-eslint/@a-2-c-2-anpm/atque-doloremque-autem
[actions-url]: https://github.com/a-2-c-2-anpm/atque-doloremque-autem/actions
